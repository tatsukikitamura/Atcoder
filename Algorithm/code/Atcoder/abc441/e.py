...
if __name__ == "__main__":
    ...
    print(f"sum(5) = {bit.sum(5)}")     
    print(f"sum(2) = {bit.sum(2)}") 
    
    print(f"query_range(3, 5) = {bit.query_range(3, 5)}") 
    ...
    print(f"配列の累積和: sum(3) = {bit2.sum(3)}") 
    print(f"区間[2, 4]の和: {bit2.query_range(2, 4)}") 
