...
class Config:
    ...
    N_TEST_CASES = 20          # Number of test cases to run (0 means all)
    DIRECTION = "minimize"     # "minimize" or "maximize"
    
    # Execution settings
    TIMEOUT = 3.0              # Timeout for each run in seconds
    ...
    DIRECTION = "minimize"     # "minimize" or "maximize"
    # These names must match what your C++ program expects as args
